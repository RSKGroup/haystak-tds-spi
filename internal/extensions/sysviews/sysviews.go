...
func tcol(n string) catalog.Column {
	return catalog.Column{Name: n, Type: types.Type{Kind: types.Time}}
}
func bitc(n string) catalog.Column {
	return catalog.Column{Name: n, Type: types.Type{Kind: types.Bool}}
}
